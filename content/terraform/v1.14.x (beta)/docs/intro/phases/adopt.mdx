...
Vault also integrates into many popular CI/CD solutions such as [GitHub, Jenkins, CircleCI, and Buildkite](/well-architected-framework/security/security-cicd-vault). Vault provides a central system to store and access data, which lets CI/CD pipelines push and pull secrets programmatically.
